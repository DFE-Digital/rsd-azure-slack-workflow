...
| <a name="input_waf_logs_teams_webhook_url"></a> [waf\_logs\_teams\_webhook\_url](#input\_waf\_logs\_teams\_webhook\_url) | Teams webhook URL for WAF Logs | `string` | `""` | no |
